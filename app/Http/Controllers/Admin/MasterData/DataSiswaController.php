...
class DataSiswaController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['thn_aka'] = \App\Models\mst_thn_aka::getMstThnAkaAttributes();
        ...
        $data['kelas'] = \App\Models\mst_kelas::getMstKelasAttributes();
    ...
    public function getSiswaSelect2(Request $request)
    {
        ...
        if (!$nis && !$nama && !$nodaftar) {
            ...
            $siswa = scctcust::when($this->unitScope, function ($query) {
